...
def parse_args():
    ...
    p.add_argument("--csv", default="data/wine-sample.csv", help="Path to CSV (default: data/wine-sample.csv)")
    ...
    p.add_argument("--test-size", type=float, default=0.1, help="Test split fraction (default: 0.3)")
...
def main():
    ...
    tracking_uri = os.getenv("MLFLOW_TRACKING_URI", "http://localhost:7000")
